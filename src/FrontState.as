package {
	...
	public class FrontState implements IRotationState {
		private var subject:RotateController;
		private var camera:Camera3D;
		public function FrontState(subject:RotateController, camera:Camera3D) {
			this.camera = camera;
		...
		public function gotoOut():void {
			...
			TweenLite.to(camera, .5, { x:400, y:400, overwrite:false, onUpdate:lookAtZero } );
			TweenLite.to(camera, .5, { z:300, delay:.5, overwrite:false, onUpdate:lookAtZero, onComplete:gotoOut_CompleteHandler } );
		}
